...
<script type="text/javascript">
            ...
            function pageselectCallback(page_index, jq){
            	...
            	var url = '<?php echo base_url()."ajax/shopajax/get_shop_task_by_method";?>';
...
<div id="managebox">
	...
	<div id="taskdiv">
		<?php 
			$data['printhistorylist'] = $this->printer_mdl->get_printer_printhistory_by_method($pterid,$perpage,0,$method);
